...
export default <Completions[]>[
  ...
  },
  {
    ...
    context: (beforeCursor: string) => {
      ...
      if (/"markup":\s*\{/.test(beforeCursor)) return (/:\s*"?(\w*)"?\s*$/).test(beforeCursor) === false;
...

  {
    ...
    context: (beforeCursor: string) => {
      ...
      if (/"liquid":\s*\{/.test(beforeCursor)) return (/:\s*"?(\w*)"?\s*$/).test(beforeCursor) === false;
...

  {
    ...
    context: (beforeCursor: string) => {
      ...
      if (/"json":\s*\{/.test(beforeCursor)) return (/:\s*"?(\w*)"?\s*$/).test(beforeCursor) === false;
  ...
  /* -------------------------------------------- */
  {
    ...
    context: (beforeCursor: string) => {
      ...
      if (/"style":\s*\{/.test(beforeCursor)) return (/:\s*"?(\w*)"?\s*$/).test(beforeCursor) === false;
